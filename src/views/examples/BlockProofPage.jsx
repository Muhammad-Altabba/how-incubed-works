...
// index page sections
import BlockProofData from "./BlockProofData.jsx";

class BlockProofPage extends React.Component {
  state = {};
  componentDidMount() {
                  ...
                  <Row>
                    <Col lg="6">
                      ...
                      <div className="lead text-white">
                        ...
                        <p className="display-4 text-white">In this sample, Incubed Client will ask for the `latest` block from Incubed Servers.</p>
                      </div>
                    </Col>
                  </Row>
                </div>
